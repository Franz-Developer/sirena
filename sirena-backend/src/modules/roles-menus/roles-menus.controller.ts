...
export class RolesMenusController {
    ...
    // PATCH /roles-menus/:id/archivar - Archivar relación (histórico)
    @Patch(':id/archivar')
    @ArchiveRateLimit()
    @InvalidateCache('roles_menus')
    archivar(
        ...
        return this.rolesMenusService.archivar<RolMenuResponseDto>(id, user.usuario_id);
    }

    // PATCH /roles-menus/:id/desarchivar - Desarchivar relación (activo)
    ...
    desarchivar(
        ...
        return this.rolesMenusService.desarchivar<RolMenuResponseDto>(id, user.usuario_id);
    }
}
