// C:\sirena\sirena-backend\src\modules\ubicaciones\dto\find-ubicaciones-query.dto.ts
...
export class FindUbicacionesQueryDto extends BasePaginationQueryDto {
    @IsOptional()
    ...
    // Todos los campos de la tabla principal (con soporte para joins a almacenes y unidades).
    ...
    static getCamposParaQ(): string[] {
        return ['codigo', 'descripcion', 'a.almacen', 'a.codigo'];
    }
    ...
    static getDependencias(): Array<string | { tabla: string; campoFk: string }> {
        return [
            { tabla: 'inventarios_fisicos', campoFk: 'ubicacion_id' },
            { tabla: 'productos_ubicaciones', campoFk: 'ubicacion_id' },
            { tabla: 'lotes_productos', campoFk: 'ubicacion_id' },
            { tabla: 'inventarios_fisicos_detalle', campoFk: 'ubicacion_id' },
            { tabla: 'ubicaciones_movimientos', campoFk: 'ubicacion_origen_id' },
            { tabla: 'ubicaciones_movimientos', campoFk: 'ubicacion_destino_id' },
            { tabla: 'ubicaciones_historial', campoFk: 'ubicacion_origen_id' },
            { tabla: 'ubicaciones_historial', campoFk: 'ubicacion_destino_id' }
        ];
    }
