// C:\sirena\sirena-backend\src\modules\cufds\dto\cufd-response.dto.ts
...
export class CufdResponseDto {
    @Expose() cufd_id!: number;
    ...
    @Expose() codigo_cufd!: string;
    @Expose() codigo_control!: string;
