...
// ==========================================
// INTERFAZ GENERAL PARA DOMINIOS PARAMÉTRICOS
// ==========================================
export interface DominioMetadata {
    id: number;
    abreviatura: string;
    prefijo: string | null;
    valor: number;
...
export const ESTADO_METADATA: Record<Estado, DominioMetadata> = {
    [Estado.ACTIVO]: { id: Estado.ACTIVO, abreviatura: 'ACTIVO', prefijo: null, valor: 0, descripcion: 'Registro operativo y vigente. Habilitado en combos y reportes operativos. Permite modificaciones y transiciona a BORRADO, HISTORICO o ANULADO. DOMINIO POR DEFECTO.' },
...
export type EstadoValue = Estado;
export type EstadosConsulta = typeof ESTADOS_CONSULTA[number];
export type EstadosVivos = typeof ESTADOS_VIVOS[number];
...
export const EVENTO_DEFAULT = [
    Evento.COMPRA
] as const;

export const EVENTO_CONSULTA = [
    Evento.COMPRA,
    Evento.VENTA,
    Evento.PROFORMA,
...
export const EVENTO_METADATA: Record<Evento, DominioMetadata> = {
    [Evento.COMPRA]: { id: Evento.COMPRA, abreviatura: 'COMPRA', prefijo: 'LOT', valor: 0, descripcion: 'Registro de ingreso de mercadería por compra a proveedor. Afecta positivamente el stock y genera cuentas por pagar. DOMINIO POR DEFECTO.' },
...
export type EventoValue = Evento;
export type EventoConsulta = typeof EVENTO_CONSULTA[number];
...
export const TIPO_COMPROBANTE_DEFAULT = [
    TipoComprobante.FACTURA
] as const;

export const TIPO_COMPROBANTE_CONSULTA = [
    TipoComprobante.FACTURA,
...
export const TIPO_COMPROBANTE_METADATA: Record<TipoComprobante, DominioMetadata> = {
    [TipoComprobante.FACTURA]: { id: TipoComprobante.FACTURA, abreviatura: 'FACTURA', prefijo: null, valor: 0, descripcion: 'Documento fiscal oficial emitido por el SIN. Genera obligación tributaria y derecho a crédito fiscal. Utilizado en ventas formales que requieren comprobante fiscal.' },
    ...
    [TipoComprobante.NINGUNO]: { id: TipoComprobante.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin comprobante fiscal definido. DOMINIO POR DEFECTO.' },
};

export type TipoComprobanteValue = TipoComprobante;
export type TipoComprobanteConsulta = typeof TIPO_COMPROBANTE_CONSULTA[number];
...
export const TIPO_CLIENTE_DEFAULT = [
    TipoCliente.NATURAL
] as const;

export const TIPO_CLIENTE_CONSULTA = [
    TipoCliente.NATURAL,
    TipoCliente.JURIDICA,
] as const;

export const TIPO_CLIENTE_METADATA: Record<TipoCliente, DominioMetadata> = {
    [TipoCliente.NATURAL]: { id: TipoCliente.NATURAL, abreviatura: 'NATURAL', prefijo: null, valor: 0, descripcion: 'Persona física individual. Requiere documento de identidad (CI, CEX, Pasaporte) para facturación. Puede tener límite de crédito personal. DOMINIO POR DEFECTO.' },
...
export type TipoClienteValue = TipoCliente;
export type TipoClienteConsulta = typeof TIPO_CLIENTE_CONSULTA[number];
...
export const GENERO_DEFAULT = [
    Genero.MASCULINO
] as const;

export const GENERO_CONSULTA = [
    Genero.MASCULINO,
    Genero.FEMENINO,
] as const;

export const GENERO_METADATA: Record<Genero, DominioMetadata> = {
    [Genero.MASCULINO]: { id: Genero.MASCULINO, abreviatura: 'MASCULINO', prefijo: null, valor: 0, descripcion: 'Género masculino. Utilizado en trabajadores y clientes. Determina el conjunto de estados civiles disponibles (1250-1254). DOMINIO POR DEFECTO.' },
...
export type GeneroValue = Genero;
export type GeneroConsulta = typeof GENERO_CONSULTA[number];
...
export const ESTADO_CIVIL_MASCULINO_DEFAULT = [
    EstadoCivilMasculino.SOLTERO
] as const;

export const ESTADO_CIVIL_MASCULINO_CONSULTA = [
    EstadoCivilMasculino.SOLTERO,
    EstadoCivilMasculino.CASADO,
    EstadoCivilMasculino.DIVORCIADO,
    EstadoCivilMasculino.VIUDO,
    EstadoCivilMasculino.UNION_LIBRE,
] as const;

export const ESTADO_CIVIL_MASCULINO_METADATA: Record<EstadoCivilMasculino, DominioMetadata> = {
    [EstadoCivilMasculino.SOLTERO]: { id: EstadoCivilMasculino.SOLTERO, abreviatura: 'SOLTERO', prefijo: null, valor: 0, descripcion: 'Estado civil soltero para género masculino. Aplica a trabajadores y clientes de sexo masculino que no tienen vínculo conyugal legal. DOMINIO POR DEFECTO.' },
...
export type EstadoCivilMasculinoValue = EstadoCivilMasculino;
export type EstadoCivilMasculinoConsulta = typeof ESTADO_CIVIL_MASCULINO_CONSULTA[number];
...
export const ESTADO_CIVIL_FEMENINO_DEFAULT = [
    EstadoCivilFemenino.SOLTERA
] as const;

export const ESTADO_CIVIL_FEMENINO_CONSULTA = [
    EstadoCivilFemenino.SOLTERA,
    EstadoCivilFemenino.CASADA,
    EstadoCivilFemenino.DIVORCIADA,
    EstadoCivilFemenino.VIUDA,
    EstadoCivilFemenino.UNION_LIBRE,
] as const;

export const ESTADO_CIVIL_FEMENINO_METADATA: Record<EstadoCivilFemenino, DominioMetadata> = {
    [EstadoCivilFemenino.SOLTERA]: { id: EstadoCivilFemenino.SOLTERA, abreviatura: 'SOLTERA', prefijo: null, valor: 0, descripcion: 'Estado civil soltera para género femenino. Aplica a trabajadoras y clientas de sexo femenino que no tienen vínculo conyugal legal. DOMINIO POR DEFECTO.' },
...
export type EstadoCivilFemeninoValue = EstadoCivilFemenino;
export type EstadoCivilFemeninoConsulta = typeof ESTADO_CIVIL_FEMENINO_CONSULTA[number];
...
export const TIPO_VENTA_DEFAULT = [
    TipoVenta.NINGUNO
] as const;

export const TIPO_VENTA_CONSULTA = [
    TipoVenta.NINGUNO,
    TipoVenta.CON_FACTURA,
    TipoVenta.SIN_FACTURA,
] as const;

export const TIPO_VENTA_METADATA: Record<TipoVenta, DominioMetadata> = {
    [TipoVenta.NINGUNO]: { id: TipoVenta.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Sin tipo de venta definido. Utilizado exclusivamente en transacciones de compra a proveedores, proformas y ajustes de inventario. No aplica a ventas a clientes. DOMINIO POR DEFECTO.' },
...
export type TipoVentaValue = TipoVenta;
export type TipoVentaConsulta = typeof TIPO_VENTA_CONSULTA[number];
...
export const TIPO_PAGO_DEFAULT = [
    TipoPago.NINGUNO
] as const;

export const TIPO_PAGO_CONSULTA = [
    TipoPago.NINGUNO,
    TipoPago.EFECTIVO,
    TipoPago.TARJETA,
    TipoPago.CHEQUE,
...
export const TIPO_PAGO_METADATA: Record<TipoPago, DominioMetadata> = {
    [TipoPago.NINGUNO]: { id: TipoPago.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Sin medio de pago definido. Utilizado exclusivamente en transacciones que no involucran cobro o pago (compras, proformas, ajustes de inventario, traspasos). No aplica para ventas a clientes. DOMINIO POR DEFECTO.' },
...
export type TipoPagoValue = TipoPago;
export type TipoPagoConsulta = typeof TIPO_PAGO_CONSULTA[number];
...
export const TIPO_MODELO_DEFAULT = [
    TipoModelo.ARIMA
] as const;

export const TIPO_MODELO_CONSULTA = [
    TipoModelo.ARIMA,
    TipoModelo.SARIMA,
    TipoModelo.SERIES_TEMPORALES,
    TipoModelo.CLASIFICACION,
    TipoModelo.OPTIMIZACION,
    TipoModelo.DETECCION_ANOMALIAS,
    TipoModelo.NINGUNO,
] as const;

export const TIPO_MODELO_METADATA: Record<TipoModelo, DominioMetadata> = {
    ...
    [TipoModelo.NINGUNO]: { id: TipoModelo.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin modelo definido. Para productos o módulos que no requieren análisis predictivo o no tienen datos suficientes. DOMINIO POR DEFECTO.' },
};

export type TipoModeloValue = TipoModelo;
export type TipoModeloConsulta = typeof TIPO_MODELO_CONSULTA[number];
...
export const TIPO_BENEFICIO_DEFAULT = [
    TipoBeneficio.DESCUENTO
] as const;

export const TIPO_BENEFICIO_CONSULTA = [
    TipoBeneficio.DESCUENTO,
    TipoBeneficio.PORCENTAJE,
    TipoBeneficio.MONTO_FIJO,
    TipoBeneficio.CANTIDAD,
    TipoBeneficio.NINGUNO,
] as const;

export const TIPO_BENEFICIO_METADATA: Record<TipoBeneficio, DominioMetadata> = {
    ...
    [TipoBeneficio.NINGUNO]: { id: TipoBeneficio.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin beneficio o promoción definida. Para productos sin oferta activa o cuando no se aplica descuento. DOMINIO POR DEFECTO.' },
};

export type TipoBeneficioValue = TipoBeneficio;
export type TipoBeneficioConsulta = typeof TIPO_BENEFICIO_CONSULTA[number];
...
export const ESTADO_PRONOSTICO_DEFAULT = [
    EstadoPronostico.PENDIENTE
] as const;

export const ESTADO_PRONOSTICO_CONSULTA = [
    EstadoPronostico.PENDIENTE,
    EstadoPronostico.PROCESADO,
    EstadoPronostico.ERROR,
    EstadoPronostico.NINGUNO,
] as const;

export const ESTADO_PRONOSTICO_METADATA: Record<EstadoPronostico, DominioMetadata> = {
    ...
    [EstadoPronostico.NINGUNO]: { id: EstadoPronostico.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin estado de pronóstico definido. Para productos que no han sido procesados por el motor de IA o que no requieren pronóstico. DOMINIO POR DEFECTO.' },
};

export type EstadoPronosticoValue = EstadoPronostico;
export type EstadoPronosticoConsulta = typeof ESTADO_PRONOSTICO_CONSULTA[number];
...
export const TEMPORADA_DEFAULT = [
    Temporada.NINGUNO
] as const;

export const TEMPORADA_CONSULTA = [
    Temporada.NINGUNO,
    Temporada.ALTA,
    Temporada.MEDIA,
    Temporada.BAJA,
...
export const TEMPORADA_METADATA: Record<Temporada, DominioMetadata> = {
    [Temporada.NINGUNO]: { id: Temporada.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin temporada definida o período transicional sin estacionalidad marcada. Para productos con demanda constante o cuando no hay datos suficientes para clasificar. DOMINIO POR DEFECTO.' },
...
export type TemporadaValue = Temporada;
export type TemporadaConsulta = typeof TEMPORADA_CONSULTA[number];
...
export const ESTADO_FISCAL_DEFAULT = [
    EstadoFiscal.ACTIVO
] as const;

export const ESTADO_FISCAL_CONSULTA = [
    EstadoFiscal.ACTIVO,
    EstadoFiscal.AGOTADO,
    EstadoFiscal.VENCIDO,
    EstadoFiscal.CANCELADO,
] as const;

export const ESTADO_FISCAL_METADATA: Record<EstadoFiscal, DominioMetadata> = {
    [EstadoFiscal.ACTIVO]: { id: EstadoFiscal.ACTIVO, abreviatura: 'ACTIVO', prefijo: null, valor: 0, descripcion: 'Dosificación fiscal vigente y operativa. Permite la emisión de facturas electrónicas con validez ante el SIN. El sistema puede generar comprobantes fiscales sin restricciones. DOMINIO POR DEFECTO.' },
...
export type EstadoFiscalValue = EstadoFiscal;
export type EstadoFiscalConsulta = typeof ESTADO_FISCAL_CONSULTA[number];
...
export const TIPO_ALMACEN_DEFAULT = [
    TipoAlmacen.NORMAL
] as const;

export const TIPO_ALMACEN_CONSULTA = [
    TipoAlmacen.NORMAL,
...
export const TIPO_ALMACEN_METADATA: Record<TipoAlmacen, DominioMetadata> = {
    [TipoAlmacen.NORMAL]: { id: TipoAlmacen.NORMAL, abreviatura: 'NORMAL', prefijo: null, valor: 0, descripcion: 'Almacén de temperatura ambiente (15°C a 30°C) para productos que no requieren condiciones especiales de conservación. Aplica para la mayoría de medicamentos de venta libre y productos de consumo regular. DOMINIO POR DEFECTO.' },
    [TipoAlmacen.REFRIGERADO]: { id: TipoAlmacen.REFRIGERADO, abreviatura: 'REFRIGERADO', prefijo: null, valor: 0, descripcion: 'Almacén refrigerado con temperatura controlada (2°C a 8°C). Para vacunas, insulinas, biológicos y medicamentos termolábiles que requieren cadena de frío. Equipado con monitoreo de temperatura continua.' },
    [TipoAlmacen.CONGELADO]: { id: TipoAlmacen.CONGELADO, abreviatura: 'CONGELADO', prefijo: null, valor: 0, descripcion: 'Almacén congelado con temperatura controlada (-18°C o menor). Para productos biológicos, hemoderivados y medicamentos que requieren congelación profunda para su conservación.' },
    [TipoAlmacen.ESPECIAL]: { id: TipoAlmacen.ESPECIAL, abreviatura: 'ESPECIAL', prefijo: null, valor: 0, descripcion: 'Almacén de alta seguridad para productos controlados (psicotrópicos, estupefacientes, sustancias fiscalizadas). Requiere doble llave, registro de accesos y control de inventario riguroso según normativa vigente.' },
...
export type TipoAlmacenValue = TipoAlmacen;
export type TipoAlmacenConsulta = typeof TIPO_ALMACEN_CONSULTA[number];
...
export const TIPO_CUENTA_DEFAULT = [
    TipoCuenta.CUENTA_CORRIENTE
] as const;

export const TIPO_CUENTA_CONSULTA = [
    TipoCuenta.CUENTA_CORRIENTE,
    TipoCuenta.CAJA_AHORROS,
    TipoCuenta.AHORRO_PROGRAMADO,
    TipoCuenta.PLAZO_FIJO,
    TipoCuenta.INVERSION,
    TipoCuenta.NO_APLICA,
] as const;

export const TIPO_CUENTA_METADATA: Record<TipoCuenta, DominioMetadata> = {
    ...
    [TipoCuenta.NO_APLICA]: { id: TipoCuenta.NO_APLICA, abreviatura: 'NO_APLICA', prefijo: null, valor: 0, descripcion: 'No aplica. Utilizado como valor por defecto cuando no se registra información de cuenta bancaria. Aplica para clientes sin cuenta asociada, transacciones en efectivo o cuando el medio de pago no requiere cuenta bancaria. DOMINIO POR DEFECTO.' },
};

export type TipoCuentaValue = TipoCuenta;
export type TipoCuentaConsulta = typeof TIPO_CUENTA_CONSULTA[number];
...
export const TIPO_DATO_DEFAULT = [
    TipoDato.STRING
] as const;

export const TIPO_DATO_CONSULTA = [
    TipoDato.STRING,
    TipoDato.INTEGER,
    TipoDato.DECIMAL,
    TipoDato.BOOLEAN,
...
export const TIPO_DATO_METADATA: Record<TipoDato, DominioMetadata> = {
    [TipoDato.STRING]: { id: TipoDato.STRING, abreviatura: 'STRING', prefijo: null, valor: 0, descripcion: 'Tipo de dato para valores de texto. Acepta caracteres alfanuméricos, espacios y símbolos. Ejemplos: "BOB", "VEN", "CASA_MATRIZ". DOMINIO POR DEFECTO.' },
...
export type TipoDatoValue = TipoDato;
export type TipoDatoConsulta = typeof TIPO_DATO_CONSULTA[number];
...
export const NIVEL_URGENCIA_DEFAULT = [
    NivelUrgencia.BAJA
] as const;

export const NIVEL_URGENCIA_CONSULTA = [
    NivelUrgencia.BAJA,
    NivelUrgencia.MEDIA,
    NivelUrgencia.ALTA,
    NivelUrgencia.CRITICA,
    NivelUrgencia.NINGUNO,
] as const;

export const NIVEL_URGENCIA_METADATA: Record<NivelUrgencia, DominioMetadata> = {
    ...
    [NivelUrgencia.NINGUNO]: { id: NivelUrgencia.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin nivel de urgencia definido. Para casos donde no aplica clasificación de urgencia. DOMINIO POR DEFECTO.' },
};

export type NivelUrgenciaValue = NivelUrgencia;
export type NivelUrgenciaConsulta = typeof NIVEL_URGENCIA_CONSULTA[number];
...
export const MOTIVO_OUTLIER_DEFAULT = [
    MotivoOutlier.BLOQUEO
] as const;

export const MOTIVO_OUTLIER_CONSULTA = [
    MotivoOutlier.BLOQUEO,
    MotivoOutlier.FERIADO_LOCAL,
    MotivoOutlier.ERROR_SISTEMA,
    MotivoOutlier.PICO_ANORMAL,
    MotivoOutlier.ROTURA,
    MotivoOutlier.ROBO,
    MotivoOutlier.SOBRANTE,
    MotivoOutlier.NINGUNO,
] as const;

export const MOTIVO_OUTLIER_METADATA: Record<MotivoOutlier, DominioMetadata> = {
    ...
    [MotivoOutlier.NINGUNO]: { id: MotivoOutlier.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin motivo de outlier definido. Cuando no se identifica una causa específica para la anomalía o cuando el pronóstico no presenta desviaciones significativas. DOMINIO POR DEFECTO.' },
};

export type MotivoOutlierValue = MotivoOutlier;
export type MotivoOutlierConsulta = typeof MOTIVO_OUTLIER_CONSULTA[number];
...
export const FORMATO_PDF_DEFAULT = [
    FormatoPDF.ESTANDAR
] as const;

export const FORMATO_PDF_CONSULTA = [
    FormatoPDF.ESTANDAR,
    FormatoPDF.RESUMIDO,
    FormatoPDF.DETALLADO,
] as const;

export const FORMATO_PDF_METADATA: Record<FormatoPDF, DominioMetadata> = {
    [FormatoPDF.ESTANDAR]: { id: FormatoPDF.ESTANDAR, abreviatura: 'ESTANDAR', prefijo: null, valor: 0, descripcion: 'Formato estándar de factura con todos los datos fiscales requeridos por el SIN. Incluye información completa del emisor, receptor, detalle de productos, impuestos desglosados y códigos de control. Aplica para facturación regular. DOMINIO POR DEFECTO.' },
...
export type FormatoPDFValue = FormatoPDF;
export type FormatoPDFConsulta = typeof FORMATO_PDF_CONSULTA[number];
...
export const ESTADO_MODELO_DEFAULT = [
    EstadoModelo.SIN_DATOS
] as const;

export const ESTADO_MODELO_CONSULTA = [
    EstadoModelo.SIN_DATOS,
    EstadoModelo.ENTRENANDO,
    EstadoModelo.ACTIVO,
    EstadoModelo.RECHAZADO,
    EstadoModelo.OBSOLETO,
] as const;

export const ESTADO_MODELO_METADATA: Record<EstadoModelo, DominioMetadata> = {
    [EstadoModelo.SIN_DATOS]: { id: EstadoModelo.SIN_DATOS, abreviatura: 'SIN_DATOS', prefijo: null, valor: 0, descripcion: 'Estado inicial cuando un producto no cuenta con datos históricos suficientes para entrenar el modelo. Requiere mínimo de registros configurado en parametros_globales. El modelo no genera predicciones hasta acumular datos suficientes. DOMINIO POR DEFECTO.' },
...
export type EstadoModeloValue = EstadoModelo;
export type EstadoModeloConsulta = typeof ESTADO_MODELO_CONSULTA[number];
...
export const CALIDAD_RATING_DEFAULT = [
    CalidadRating.PESIMO
] as const;

export const CALIDAD_RATING_CONSULTA = [
    CalidadRating.PESIMO,
    CalidadRating.DEFICIENTE,
    CalidadRating.REGULAR,
    CalidadRating.BUENO,
    CalidadRating.EXCELENTE,
    CalidadRating.NINGUNO,
] as const;

export const CALIDAD_RATING_METADATA: Record<CalidadRating, DominioMetadata> = {
    ...
    [CalidadRating.NINGUNO]: { id: CalidadRating.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin calificación de calidad definida. Para proveedores nuevos o cuando aún no se ha realizado evaluación formal de desempeño. DOMINIO POR DEFECTO.' },
};

export type CalidadRatingValue = CalidadRating;
export type CalidadRatingConsulta = typeof CALIDAD_RATING_CONSULTA[number];
...
export const ESTADO_TRASPASO_DEFAULT = [
    EstadoTraspaso.EN_TRANSITO
] as const;

export const ESTADO_TRASPASO_CONSULTA = [
    EstadoTraspaso.EN_TRANSITO,
    EstadoTraspaso.RECIBIDO,
    EstadoTraspaso.RECHAZADO,
    EstadoTraspaso.NO_APLICA,
] as const;

export const ESTADO_TRASPASO_METADATA: Record<EstadoTraspaso, DominioMetadata> = {
    ...
    [EstadoTraspaso.NO_APLICA]: { id: EstadoTraspaso.NO_APLICA, abreviatura: 'NO_APLICA', prefijo: null, valor: 0, descripcion: 'Estado por defecto para transacciones que no son traspasos inter-sucursales. Aplica para compras, ventas, proformas, ajustes y cualquier otro evento que no involucre movimiento entre almacenes. DOMINIO POR DEFECTO.' },
};

export type EstadoTraspasoValue = EstadoTraspaso;
export type EstadoTraspasoConsulta = typeof ESTADO_TRASPASO_CONSULTA[number];
...
export const MODULO_ESTRATEGICO_DEFAULT = [
    ModuloEstrategico.FLUJO_CAJA
] as const;

export const MODULO_ESTRATEGICO_CONSULTA = [
    ModuloEstrategico.FLUJO_CAJA,
    ModuloEstrategico.DEMANDA_INVENTARIO,
    ModuloEstrategico.PROVEEDORES_AHP,
    ModuloEstrategico.OPERACION_MERMAS,
    ModuloEstrategico.CLIENTES_RFM,
    ModuloEstrategico.PRECIOS_ELASTICIDAD,
    ModuloEstrategico.ANOMALIAS_FRAUDE,
    ModuloEstrategico.NINGUNO,
] as const;

export const MODULO_ESTRATEGICO_METADATA: Record<ModuloEstrategico, DominioMetadata> = {
    ...
    [ModuloEstrategico.NINGUNO]: { id: ModuloEstrategico.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin módulo estratégico definido. Valor por defecto para tareas y procesos que no pertenecen a un módulo específico o que aún no han sido clasificados. DOMINIO POR DEFECTO.' },
};

export type ModuloEstrategicoValue = ModuloEstrategico;
export type ModuloEstrategicoConsulta = typeof MODULO_ESTRATEGICO_CONSULTA[number];
...
export const TIPO_DOCUMENTO_DEFAULT = [
    TipoDocumento.CEDULA_IDENTIDAD
] as const;

export const TIPO_DOCUMENTO_CONSULTA = [
    TipoDocumento.CEDULA_IDENTIDAD,
    TipoDocumento.CEDULA_IDENTIDAD_EXTRANJERO,
    TipoDocumento.PASAPORTE,
    TipoDocumento.OTRO,
    TipoDocumento.NIT,
] as const;

export const TIPO_DOCUMENTO_METADATA: Record<TipoDocumento, DominioMetadata> = {
    [TipoDocumento.CEDULA_IDENTIDAD]: { id: TipoDocumento.CEDULA_IDENTIDAD, abreviatura: 'CEDULA_IDENTIDAD', prefijo: 'CI', valor: 1, descripcion: 'Cédula de identidad boliviana. Documento nacional emitido por el SEGIP. Formato: numérico (ej. 1234567) o con complemento (ej. 1234567-1A). DOMINIO POR DEFECTO.' },
...
export type TipoDocumentoValue = TipoDocumento;
export type TipoDocumentoConsulta = typeof TIPO_DOCUMENTO_CONSULTA[number];
...
export const ESTADO_PEDIDO_DEFAULT = [
    EstadoPedido.COTIZADO
] as const;

export const ESTADO_PEDIDO_CONSULTA = [
    EstadoPedido.COTIZADO,
...
export const ESTADO_PEDIDO_METADATA: Record<EstadoPedido, DominioMetadata> = {
    [EstadoPedido.COTIZADO]: { id: EstadoPedido.COTIZADO, abreviatura: 'COTIZADO', prefijo: 'COT', valor: 1, descripcion: 'Pedido cotizado y en espera de aprobación administrativa. No afecta stock ni genera obligación de compra. Estado inicial del flujo. DOMINIO POR DEFECTO.' },
...
export type EstadoPedidoConsulta = typeof ESTADO_PEDIDO_CONSULTA[number];
...
export const TIPO_MONEDA_DEFAULT = [
    TipoMoneda.BOLIVIANO
] as const;

export const TIPO_MONEDA_CONSULTA = [
    TipoMoneda.BOLIVIANO,
    TipoMoneda.DOLAR,
    TipoMoneda.EURO,
    TipoMoneda.UFV,
...
export const TIPO_MONEDA_METADATA: Record<TipoMoneda, DominioMetadata> = {
    [TipoMoneda.BOLIVIANO]: { id: TipoMoneda.BOLIVIANO, abreviatura: 'BOLIVIANO', prefijo: 'BOB', valor: 1, descripcion: 'Boliviano (Bs.). Moneda oficial de Bolivia. Utilizada como moneda base del sistema para todas las transacciones locales, facturación y reportes financieros. DOMINIO POR DEFECTO.' },
...
export type TipoMonedaValue = TipoMoneda;
export type TipoMonedaConsulta = typeof TIPO_MONEDA_CONSULTA[number];
...
export const TIPO_FACTURA_DEFAULT = [
    TipoFactura.CON_FACTURA
] as const;

export const TIPO_FACTURA_CONSULTA = [
    TipoFactura.CON_FACTURA,
    TipoFactura.SIN_FACTURA,
    TipoFactura.NOTA_CREDITO_DEBITO,
    TipoFactura.NINGUNO,
] as const;

export const TIPO_FACTURA_METADATA: Record<TipoFactura, DominioMetadata> = {
    ...
    [TipoFactura.NINGUNO]: { id: TipoFactura.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 4, descripcion: 'Sin tipo de factura definido. Valor por defecto para transacciones que no requieren facturación fiscal, como proformas, ajustes de inventario o traspasos internos. DOMINIO POR DEFECTO.' },
};

export type TipoFacturaValue = TipoFactura;
export type TipoFacturaConsulta = typeof TIPO_FACTURA_CONSULTA[number];
...
export const ESTADO_FINANCIERO_DEFAULT = [
    EstadoFinanciero.CANCELADO
] as const;

export const ESTADO_FINANCIERO_CONSULTA = [
    EstadoFinanciero.CANCELADO,
    EstadoFinanciero.PENDIENTE,
    EstadoFinanciero.PARCIAL,
    EstadoFinanciero.NINGUNO,
] as const;

export const ESTADO_FINANCIERO_METADATA: Record<EstadoFinanciero, DominioMetadata> = {
    ...
    [EstadoFinanciero.NINGUNO]: { id: EstadoFinanciero.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin estado financiero definido. Valor por defecto para transacciones que no generan obligación financiera, como proformas, ajustes de inventario o movimientos internos. DOMINIO POR DEFECTO.' },
};

export type EstadoFinancieroValue = EstadoFinanciero;
export type EstadoFinancieroConsulta = typeof ESTADO_FINANCIERO_CONSULTA[number];
...
export const MOTIVO_ANULACION_DEFAULT = [
    MotivoAnulacion.FACTURA_MAL_EMITIDA
] as const;

export const MOTIVO_ANULACION_CONSULTA = [
    MotivoAnulacion.FACTURA_MAL_EMITIDA,
    MotivoAnulacion.ERROR_DATOS_CLIENTE,
    MotivoAnulacion.DEVOLUCION_MERCADERIA,
    MotivoAnulacion.CONTINGENCIA,
    MotivoAnulacion.OPERACION_NO_CONCRETADA,
    MotivoAnulacion.NINGUNO,
] as const;

export const MOTIVO_ANULACION_METADATA: Record<MotivoAnulacion, DominioMetadata> = {
    ...
    [MotivoAnulacion.NINGUNO]: { id: MotivoAnulacion.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Sin motivo de anulación definido. Valor por defecto para casos donde no se requiere justificación o cuando la anulación es automática por sistema (ej. expiración de reservas). DOMINIO POR DEFECTO.' },
};

export type MotivoAnulacionValue = MotivoAnulacion;
export type MotivoAnulacionConsulta = typeof MOTIVO_ANULACION_CONSULTA[number];
...
export const ESTADO_LOTE_DEFAULT = [
    EstadoLote.VIGENTE
] as const;

export const ESTADO_LOTE_CONSULTA = [
    EstadoLote.VIGENTE,
    EstadoLote.VENCIDO,
    EstadoLote.AGOTADO,
    EstadoLote.NINGUNO,
...
export const ESTADO_LOTE_METADATA: Record<EstadoLote, DominioMetadata> = {
    ...
    [EstadoLote.NINGUNO]: { id: EstadoLote.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin estado de lote definido. Valor por defecto para el registro comodín o casos excepcionales donde no se requiere clasificación de estado. DOMINIO POR DEFECTO.' },
};

export type EstadoLoteValue = EstadoLote;
export type EstadoLoteConsulta = typeof ESTADO_LOTE_CONSULTA[number];
...
export const ESTADO_PAGO_DEFAULT = [
    EstadoPago.PENDIENTE
] as const;

export const ESTADO_PAGO_CONSULTA = [
    EstadoPago.PENDIENTE,
    EstadoPago.PARCIAL,
    EstadoPago.PAGADO,
    EstadoPago.CERRADO,
...
export const ESTADO_PAGO_METADATA: Record<EstadoPago, DominioMetadata> = {
    ...
    [EstadoPago.NINGUNO]: { id: EstadoPago.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin estado de pago definido. Valor por defecto para registros comodín o cuando no aplica un estado específico. DOMINIO POR DEFECTO.' },
};

export type EstadoPagoValue = EstadoPago;
export type EstadoPagoConsulta = typeof ESTADO_PAGO_CONSULTA[number];
...
export const TIPO_MOVIMIENTO_DEFAULT = [
    TipoMovimiento.INGRESO
] as const;

export const TIPO_MOVIMIENTO_CONSULTA = [
    TipoMovimiento.INGRESO,
    TipoMovimiento.EGRESO,
] as const;

export const TIPO_MOVIMIENTO_METADATA: Record<TipoMovimiento, DominioMetadata> = {
    [TipoMovimiento.INGRESO]: { id: TipoMovimiento.INGRESO, abreviatura: 'INGRESO', prefijo: null, valor: 0, descripcion: 'Movimiento que incrementa el saldo de caja. Aplica para cobros, ventas, depósitos, devoluciones de clientes y cualquier entrada de dinero. Aumenta el monto_ingresos de la caja. DOMINIO POR DEFECTO.' },
...
export type TipoMovimientoValue = TipoMovimiento;
export type TipoMovimientoConsulta = typeof TIPO_MOVIMIENTO_CONSULTA[number];
...
export const ESTADO_CAJA_DEFAULT = [
    EstadoCaja.ABIERTA
] as const;

export const ESTADO_CAJA_CONSULTA = [
    EstadoCaja.ABIERTA,
    EstadoCaja.CERRADA,
] as const;

export const ESTADO_CAJA_METADATA: Record<EstadoCaja, DominioMetadata> = {
    [EstadoCaja.ABIERTA]: { id: EstadoCaja.ABIERTA, abreviatura: 'ABIERTA', prefijo: null, valor: 0, descripcion: 'Caja operativa y disponible para recibir transacciones. Permite registrar ventas, cobros, pagos y movimientos de efectivo. Estado activo durante la jornada laboral. DOMINIO POR DEFECTO.' },
...
export type EstadoCajaValue = EstadoCaja;
export type EstadoCajaConsulta = typeof ESTADO_CAJA_CONSULTA[number];
...
export const TIPO_ALERTA_NOTIFICACION_DEFAULT = [
    TipoAlertaNotificacion.SISTEMA
] as const;

export const TIPO_ALERTA_NOTIFICACION_CONSULTA = [
    TipoAlertaNotificacion.SISTEMA,
    TipoAlertaNotificacion.ALERTA_STOCK,
    TipoAlertaNotificacion.STOCK_BAJO,
    TipoAlertaNotificacion.STOCK_CRITICO,
    TipoAlertaNotificacion.STOCK_EXCESO,
    TipoAlertaNotificacion.VENCIMIENTO_PROXIMO,
    TipoAlertaNotificacion.VENCIMIENTO_INMEDIATO,
    TipoAlertaNotificacion.VENCIMIENTO_VENCIDO,
    TipoAlertaNotificacion.DEMANDA_ALTA,
    TipoAlertaNotificacion.DEMANDA_BAJA,
    TipoAlertaNotificacion.TENDENCIA_ANOMALA,
    TipoAlertaNotificacion.PREDICCION_ROP,
    TipoAlertaNotificacion.PREDICCION_DEMANDA,
    TipoAlertaNotificacion.FORECASTING,
    TipoAlertaNotificacion.PAGOS,
    TipoAlertaNotificacion.PAGO_VENCIDO,
    TipoAlertaNotificacion.PAGO_PROXIMO,
    TipoAlertaNotificacion.DOCUMENTOS,
    TipoAlertaNotificacion.FACTURA_PENDIENTE,
    TipoAlertaNotificacion.FACTURA_ANULADA,
    TipoAlertaNotificacion.SEGURIDAD_ACCESO,
    TipoAlertaNotificacion.SEGURIDAD_INTENTO_FALLIDO,
    TipoAlertaNotificacion.SISTEMA_ERROR,
    TipoAlertaNotificacion.SISTEMA_RENDIMIENTO,
    TipoAlertaNotificacion.NINGUNO,
    TipoAlertaNotificacion.RRHH_FALTAS,
    TipoAlertaNotificacion.RRHH_CONTRATO,
    TipoAlertaNotificacion.RRHH_PLANILLA,
] as const;

export const TIPO_ALERTA_NOTIFICACION_METADATA: Record<TipoAlertaNotificacion, DominioMetadata> = {
    ...
    [TipoAlertaNotificacion.NINGUNO]: { id: TipoAlertaNotificacion.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin tipo de alerta definido. Valor por defecto para registros comodín o casos donde no se requiere clasificación de alerta. DOMINIO POR DEFECTO.' },
...
export type TipoAlertaNotificacionValue = TipoAlertaNotificacion;
export type TipoAlertaNotificacionConsulta = typeof TIPO_ALERTA_NOTIFICACION_CONSULTA[number];
...
export const AMBIENTE_DEFAULT = [
    Ambiente.PRODUCCION
] as const;

export const AMBIENTE_CONSULTA = [
    Ambiente.PRODUCCION,
    Ambiente.PILOTO_PRUEBAS,
] as const;

export const AMBIENTE_METADATA: Record<Ambiente, DominioMetadata> = {
    ...
    [Ambiente.PILOTO_PRUEBAS]: { id: Ambiente.PILOTO_PRUEBAS, abreviatura: 'PILOTO_PRUEBAS', prefijo: null, valor: 2, descripcion: 'Ambiente del sistema en piloto ó pruebas. DOMINIO POR DEFECTO.' },
};

export type AmbienteValue = Ambiente;
export type AmbienteConsulta = typeof AMBIENTE_CONSULTA[number];
...
export const SUBTIPO_ALERTA_DEFAULT = [
    SubtipoAlerta.SARIMA
] as const;

export const SUBTIPO_ALERTA_CONSULTA = [
    SubtipoAlerta.SARIMA,
    SubtipoAlerta.PROPHET,
    SubtipoAlerta.KMEANS,
    SubtipoAlerta.ROP_CALC,
    SubtipoAlerta.PATRON_CONSUMO,
    SubtipoAlerta.ALERTA_PREDICTIVA,
    SubtipoAlerta.QUIEBRE_STOCK,
    SubtipoAlerta.REORDEN,
    SubtipoAlerta.EXCESO,
    SubtipoAlerta.CADUCIDAD_CRITICA,
    SubtipoAlerta.CADUCIDAD_ALTA,
    SubtipoAlerta.CADUCIDAD_MEDIA,
    SubtipoAlerta.NINGUNO,
] as const;

export const SUBTIPO_ALERTA_METADATA: Record<SubtipoAlerta, DominioMetadata> = {
    [SubtipoAlerta.SARIMA]: { id: SubtipoAlerta.SARIMA, abreviatura: 'SARIMA', prefijo: null, valor: 0, descripcion: 'Subtipo SARIMA' },
    ...
    [SubtipoAlerta.NINGUNO]: { id: SubtipoAlerta.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin subtipo de alerta definido o no aplica. DOMINIO POR DEFECTO.' },
};

export type SubtipoAlertaValue = SubtipoAlerta;
export type SubtipoAlertaConsulta = typeof SUBTIPO_ALERTA_CONSULTA[number];
...
export const ORIGEN_ALERTA_DEFAULT = [
    OrigenAlerta.SISTEMA
] as const;

export const ORIGEN_ALERTA_CONSULTA = [
    OrigenAlerta.SISTEMA,
    OrigenAlerta.IA,
    OrigenAlerta.USUARIO,
    OrigenAlerta.TAREA_PROGRAMADA,
] as const;

export const ORIGEN_ALERTA_METADATA: Record<OrigenAlerta, DominioMetadata> = {
    [OrigenAlerta.SISTEMA]: { id: OrigenAlerta.SISTEMA, abreviatura: 'SISTEMA', prefijo: null, valor: 0, descripcion: 'Alerta generada por el sistema operativo o módulos internos. Incluye eventos de seguridad, errores de procesos y notificaciones automáticas. Origen más común. DOMINIO POR DEFECTO.' },
...
export type OrigenAlertaValue = OrigenAlerta;
export type OrigenAlertaConsulta = typeof ORIGEN_ALERTA_CONSULTA[number];
...
export const NIVEL_CRITICO_DEFAULT = [
    NivelCritico.CRITICO
] as const;

export const NIVEL_CRITICO_CONSULTA = [
    NivelCritico.CRITICO,
    NivelCritico.ALTA,
    NivelCritico.MEDIA,
    NivelCritico.BAJA,
    NivelCritico.INFORMATIVA,
    NivelCritico.NINGUNO,
] as const;

export const NIVEL_CRITICO_METADATA: Record<NivelCritico, DominioMetadata> = {
    ...
    [NivelCritico.NINGUNO]: { id: NivelCritico.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin nivel crítico definido. Valor por defecto para casos donde no aplica clasificación de criticidad. DOMINIO POR DEFECTO.' },
};

export type NivelCriticoValue = NivelCritico;
export type NivelCriticoConsulta = typeof NIVEL_CRITICO_CONSULTA[number];
...
export const ESTADO_ALERTA_DEFAULT = [
    EstadoAlerta.PENDIENTE
] as const;

export const ESTADO_ALERTA_CONSULTA = [
    EstadoAlerta.PENDIENTE,
    EstadoAlerta.EN_PROCESO,
    EstadoAlerta.RESUELTA,
    EstadoAlerta.IGNORADA,
    EstadoAlerta.ESCALADA,
    EstadoAlerta.NINGUNO,
] as const;

export const ESTADO_ALERTA_METADATA: Record<EstadoAlerta, DominioMetadata> = {
    ...
    [EstadoAlerta.NINGUNO]: { id: EstadoAlerta.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin estado de alerta definido. Valor por defecto para registros comodín o cuando no aplica clasificación de estado de alerta. DOMINIO POR DEFECTO.' },
};

export type EstadoAlertaValue = EstadoAlerta;
export type EstadoAlertaConsulta = typeof ESTADO_ALERTA_CONSULTA[number];
...
export const FRAMEWORK_DEFAULT = [
    Framework.STATSMODELS
] as const;

export const FRAMEWORK_CONSULTA = [
    Framework.STATSMODELS,
...
export const FRAMEWORK_METADATA: Record<Framework, DominioMetadata> = {
    ...
    [Framework.NINGUNO]: { id: Framework.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin framework definido. Valor por defecto para modelos que no utilizan un framework específico o cuando no aplica. DOMINIO POR DEFECTO.' },
};

export type FrameworkValue = Framework;
export type FrameworkConsulta = typeof FRAMEWORK_CONSULTA[number];
...
export const ESTADO_EJECUCION_DEFAULT = [
    EstadoEjecucion.EN_PROCESO
] as const;

export const ESTADO_EJECUCION_CONSULTA = [
    EstadoEjecucion.EN_PROCESO,
    EstadoEjecucion.COMPLETADO,
    EstadoEjecucion.FALLIDO,
    EstadoEjecucion.NINGUNO,
] as const;

export const ESTADO_EJECUCION_METADATA: Record<EstadoEjecucion, DominioMetadata> = {
    ...
    [EstadoEjecucion.NINGUNO]: { id: EstadoEjecucion.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin estado de ejecución definido. Valor por defecto para registros comodín o cuando no se ha registrado estado de ejecución. DOMINIO POR DEFECTO.' },
};

export type EstadoEjecucionValue = EstadoEjecucion;
export type EstadoEjecucionConsulta = typeof ESTADO_EJECUCION_CONSULTA[number];

// ==========================================
// TIPO METRICAS
// ==========================================
export enum TipoMetricas {
    REGRESION = 3100,
    CLASIFICACION = 3101,
    CLUSTERING = 3102,
    NINGUNO = 3103,
...
export const TIPO_METRICAS_DEFAULT = [
    TipoMetricas.REGRESION
] as const;

export const TIPO_METRICAS_CONSULTA = [
    TipoMetricas.REGRESION,
    TipoMetricas.CLASIFICACION,
    TipoMetricas.CLUSTERING,
    TipoMetricas.NINGUNO,
] as const;

export const TIPO_METRICAS_METADATA: Record<TipoMetricas, DominioMetadata> = {
    [TipoMetricas.REGRESION]: { id: TipoMetricas.REGRESION, abreviatura: 'REGRESION', prefijo: null, valor: 0, descripcion: 'Métricas para modelos de regresión. Incluye MAE, RMSE, MAPE, R2 y otras métricas que evalúan la precisión de predicciones numéricas. Aplica para pronósticos de demanda y series temporales.' },
    [TipoMetricas.CLASIFICACION]: { id: TipoMetricas.CLASIFICACION, abreviatura: 'CLASIFICACION', prefijo: null, valor: 0, descripcion: 'Métricas para modelos de clasificación. Incluye F1 Score, precisión, sensibilidad y exactitud. Aplica para segmentación de clientes, clasificación de productos y detección de anomalías.' },
    [TipoMetricas.CLUSTERING]: { id: TipoMetricas.CLUSTERING, abreviatura: 'CLUSTERING', prefijo: null, valor: 0, descripcion: 'Métricas para modelos de clustering. Incluye coeficiente de silueta, índice de Davies-Bouldin y otras métricas de calidad de agrupamiento. Aplica para segmentación ABC y agrupación de datos.' },
    [TipoMetricas.NINGUNO]: { id: TipoMetricas.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin tipo de métrica definido. Valor por defecto para casos donde no se requiere clasificación específica de métricas. DOMINIO POR DEFECTO.' },
};

export type TipoMetricasValue = TipoMetricas;
export type TipoMetricasConsulta = typeof TIPO_METRICAS_CONSULTA[number];
...
export const NIVEL_LOG_DEFAULT = [
    NivelLog.INFO
] as const;

export const NIVEL_LOG_CONSULTA = [
    NivelLog.INFO,
    NivelLog.WARNING,
    NivelLog.ERROR,
    NivelLog.DEBUG,
...
export const NIVEL_LOG_METADATA: Record<NivelLog, DominioMetadata> = {
    [NivelLog.INFO]: { id: NivelLog.INFO, abreviatura: 'INFO', prefijo: null, valor: 0, descripcion: 'Log informativo. Registra eventos normales del sistema, procesos exitosos y cambios de estado. No requiere acción. Utilizado para trazabilidad operativa. DOMINIO POR DEFECTO.' },
...
export type NivelLogValue = NivelLog;
export type NivelLogConsulta = typeof NIVEL_LOG_CONSULTA[number];
...
export type TipoUbicacionMovimientoValue = TipoUbicacionMovimiento;
export type TipoUbicacionMovimientoConsulta = typeof TIPO_UBICACION_MOVIMIENTO_CONSULTA[number];
...
export const TIPO_UMBRAL_DEFAULT = [
    TipoUmbral.STOCK_MINIMO
] as const;

export const TIPO_UMBRAL_CONSULTA = [
    TipoUmbral.STOCK_MINIMO,
    TipoUmbral.DIAS_VENCIMIENTO,
    TipoUmbral.ERROR_PREDICCION,
    TipoUmbral.NINGUNO,
] as const;

export const TIPO_UMBRAL_METADATA: Record<TipoUmbral, DominioMetadata> = {
    [TipoUmbral.STOCK_MINIMO]: { id: TipoUmbral.STOCK_MINIMO, abreviatura: 'STOCK_MINIMO', prefijo: null, valor: 0, descripcion: 'Umbral de stock mínimo. Define el nivel mínimo de inventario permitido para un producto. Cuando el stock cae por debajo de este valor, se activa una alerta de reposición. DOMINIO POR DEFECTO.' },
...
export type TipoUmbralValue = TipoUmbral;
export type TipoUmbralConsulta = typeof TIPO_UMBRAL_CONSULTA[number];
...
export const ESTADO_DOCUMENTO_DEFAULT = [
    EstadoDocumento.EMITIDO
] as const;

export const ESTADO_DOCUMENTO_CONSULTA = [
    EstadoDocumento.EMITIDO,
    EstadoDocumento.ANULADO,
    EstadoDocumento.ANULADO_PARCIAL,
] as const;

export const ESTADO_DOCUMENTO_METADATA: Record<EstadoDocumento, DominioMetadata> = {
    [EstadoDocumento.EMITIDO]: { id: EstadoDocumento.EMITIDO, abreviatura: 'EMITIDO', prefijo: null, valor: 0, descripcion: 'Documento emitido y vigente. El comprobante fiscal ha sido generado y registrado correctamente. Es válido ante el SIN. DOMINIO POR DEFECTO.' },
...
export type EstadoDocumentoValue = EstadoDocumento;
export type EstadoDocumentoConsulta = typeof ESTADO_DOCUMENTO_CONSULTA[number];
...
export const FRECUENCIA_DEFAULT = [
    Frecuencia.MINUTOS
] as const;

export const FRECUENCIA_CONSULTA = [
    Frecuencia.MINUTOS,
    Frecuencia.HORAS,
    Frecuencia.DIARIO,
    Frecuencia.SEMANAL,
    ...
    Frecuencia.CRON,
    Frecuencia.CONTINUA,
    Frecuencia.TRIGGER_EVENTO,
    Frecuencia.NINGUNO,
] as const;

export const FRECUENCIA_METADATA: Record<Frecuencia, DominioMetadata> = {
    ...
    [Frecuencia.NINGUNO]: { id: Frecuencia.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin frecuencia definida. Valor por defecto para tareas que no requieren programación automática o que se ejecutan de forma manual. DOMINIO POR DEFECTO.' },
};

export type FrecuenciaValue = Frecuencia;
export type FrecuenciaConsulta = typeof FRECUENCIA_CONSULTA[number];
...
export const TIPO_TAREA_DEFAULT = [
    TipoTarea.REPORTE
] as const;

export const TIPO_TAREA_CONSULTA = [
    TipoTarea.REPORTE,
    TipoTarea.IA_MODELO,
    TipoTarea.BACKUP,
    TipoTarea.ALERTA,
    TipoTarea.MANTENIMIENTO,
    TipoTarea.FORECASTING,
    TipoTarea.CLASIFICACION,
    TipoTarea.OPTIMIZACION,
    TipoTarea.VALIDACION,
    TipoTarea.NINGUNO,
] as const;

export const TIPO_TAREA_METADATA: Record<TipoTarea, DominioMetadata> = {
    ...
    [TipoTarea.NINGUNO]: { id: TipoTarea.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin tipo de tarea definido. Valor por defecto para tareas no clasificadas o cuando no aplica tipo específico. DOMINIO POR DEFECTO.' },
};

export type TipoTareaValue = TipoTarea;
export type TipoTareaConsulta = typeof TIPO_TAREA_CONSULTA[number];
...
export const SUBTIPO_TAREA_DEFAULT = [
    SubtipoTarea.SARIMA
] as const;

export const SUBTIPO_TAREA_CONSULTA = [
    SubtipoTarea.SARIMA,
    SubtipoTarea.SARIMAX,
    SubtipoTarea.PROPHET,
    SubtipoTarea.KMEANS,
    SubtipoTarea.ROP_CALC,
    SubtipoTarea.PATRON_CONSUMO,
    SubtipoTarea.ALERTA_PREDICTIVA,
    SubtipoTarea.VARIABLE_EXOGENA,
    SubtipoTarea.METRICA_RENDIMIENTO,
    SubtipoTarea.REENTRENAMIENTO,
    SubtipoTarea.VALIDACION_CROSS,
    SubtipoTarea.NINGUNO,
] as const;

export const SUBTIPO_TAREA_METADATA: Record<SubtipoTarea, DominioMetadata> = {
    ...
    [SubtipoTarea.NINGUNO]: { id: SubtipoTarea.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Sin subtipo de tarea definido. Valor por defecto para tareas que no requieren clasificación específica o cuando no aplica subtipo. DOMINIO POR DEFECTO.' },
};

export type SubtipoTareaValue = SubtipoTarea;
export type SubtipoTareaConsulta = typeof SUBTIPO_TAREA_CONSULTA[number];
...
export const MOTIVO_DEVOLUCION_DEFAULT = [
    MotivoDevolucion.PRODUCTO_VENCIDO
] as const;

export const MOTIVO_DEVOLUCION_CONSULTA = [
    MotivoDevolucion.PRODUCTO_VENCIDO,
    MotivoDevolucion.PRODUCTO_DAÑADO,
    MotivoDevolucion.ERROR_PEDIDO,
    MotivoDevolucion.EXCESO_STOCK,
    MotivoDevolucion.DESCONTINUADO,
    MotivoDevolucion.DEVOLUCION_CLIENTE,
    MotivoDevolucion.NINGUNO,
    MotivoDevolucion.PRODUCTO_NO_SOLICITADO,
    MotivoDevolucion.PRODUCTO_DEFECTUOSO,
] as const;

export const MOTIVO_DEVOLUCION_METADATA: Record<MotivoDevolucion, DominioMetadata> = {
    ...
    [MotivoDevolucion.NINGUNO]: { id: MotivoDevolucion.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Sin motivo de devolución definido. Valor por defecto para transacciones que no requieren clasificación de devolución o cuando no aplica motivo específico. DOMINIO POR DEFECTO.' },
...
export type MotivoDevolucionValue = MotivoDevolucion;
export type MotivoDevolucionConsulta = typeof MOTIVO_DEVOLUCION_CONSULTA[number];
...
export const TIPO_DESPACHO_DEFAULT = [
    TipoDespacho.VENTA_MOSTRADOR
] as const;

export const TIPO_DESPACHO_CONSULTA = [
    TipoDespacho.VENTA_MOSTRADOR,
    TipoDespacho.DOMICILIO,
    TipoDespacho.RETIRO,
    TipoDespacho.TRANSFERENCIA,
    TipoDespacho.NINGUNO,
] as const;

export const TIPO_DESPACHO_METADATA: Record<TipoDespacho, DominioMetadata> = {
    ...
    [TipoDespacho.NINGUNO]: { id: TipoDespacho.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Sin tipo de despacho definido. Valor por defecto para transacciones que não requieren clasificación de despacho, como compras a proveedores, ajustes de inventario o movimientos internos. DOMINIO POR DEFECTO.' },
};

export type TipoDespachoValue = TipoDespacho;
export type TipoDespachoConsulta = typeof TIPO_DESPACHO_CONSULTA[number];
...
export const METRICA_PRECISION_DEFAULT = [
    MetricaPrecision.MAE
] as const;

export const METRICA_PRECISION_CONSULTA = [
    MetricaPrecision.MAE,
    MetricaPrecision.RMSE,
    MetricaPrecision.MAPE,
    MetricaPrecision.R2,
    MetricaPrecision.F1,
    MetricaPrecision.NINGUNO,
] as const;

export const METRICA_PRECISION_METADATA: Record<MetricaPrecision, DominioMetadata> = {
    ...
    [MetricaPrecision.NINGUNO]: { id: MetricaPrecision.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Sin métrica de precisión definida. Valor por defecto para modelos que no han sido evaluados o cuando no aplica métrica específica. DOMINIO POR DEFECTO.' },
};

export type MetricaPrecisionValue = MetricaPrecision;
export type MetricaPrecisionConsulta = typeof METRICA_PRECISION_CONSULTA[number];
...
export const FACTOR_ESTACIONALIDAD_DEFAULT = [
    FactorEstacionalidad.NONE
] as const;

export const FACTOR_ESTACIONALIDAD_CONSULTA = [
    FactorEstacionalidad.NONE,
    FactorEstacionalidad.DIARIO,
    FactorEstacionalidad.SEMANAL,
    FactorEstacionalidad.MENSUAL,
    FactorEstacionalidad.ANUAL,
    FactorEstacionalidad.MULTIPLE,
] as const;

export const FACTOR_ESTACIONALIDAD_METADATA: Record<FactorEstacionalidad, DominioMetadata> = {
    [FactorEstacionalidad.NONE]: { id: FactorEstacionalidad.NONE, abreviatura: 'NONE', prefijo: 'NON', valor: 0, descripcion: 'Sin componente estacional. El modelo no considera estacionalidad en el pronóstico. Aplica para productos con demanda constante o cuando la estacionalidad no es significativa. DOMINIO POR DEFECTO.' },
...
export type FactorEstacionalidadValue = FactorEstacionalidad;
export type FactorEstacionalidadConsulta = typeof FACTOR_ESTACIONALIDAD_CONSULTA[number];
...
export const ESTADO_PEDIDO_ONLINE_DEFAULT = [
    EstadoPedidoOnline.PENDIENTE
] as const;

export const ESTADO_PEDIDO_ONLINE_CONSULTA = [
    EstadoPedidoOnline.PENDIENTE,
    EstadoPedidoOnline.CONFIRMADO,
    EstadoPedidoOnline.PREPARANDO,
    EstadoPedidoOnline.EN_CAMINO,
    EstadoPedidoOnline.ENTREGADO,
    EstadoPedidoOnline.CANCELADO,
    EstadoPedidoOnline.RECHAZADO,
] as const;

export const ESTADO_PEDIDO_ONLINE_METADATA: Record<EstadoPedidoOnline, DominioMetadata> = {
    [EstadoPedidoOnline.PENDIENTE]: { id: EstadoPedidoOnline.PENDIENTE, abreviatura: 'PENDIENTE', prefijo: null, valor: 0, descripcion: 'Pedido recibido, pendiente de confirmación. DOMINIO POR DEFECTO.' },
...
export type EstadoPedidoOnlineValue = EstadoPedidoOnline;
export type EstadoPedidoOnlineConsulta = typeof ESTADO_PEDIDO_ONLINE_CONSULTA[number];
...
export const METODO_CALCULO_DEFAULT = [
    MetodoCalculo.PONDERADO
] as const;

export const METODO_CALCULO_CONSULTA = [
    MetodoCalculo.PONDERADO,
    MetodoCalculo.FIFO,
    MetodoCalculo.ULTIMA_COMPRA,
] as const;

export const METODO_CALCULO_METADATA: Record<MetodoCalculo, DominioMetadata> = {
    [MetodoCalculo.PONDERADO]: { id: MetodoCalculo.PONDERADO, abreviatura: 'PONDERADO', prefijo: null, valor: 0, descripcion: 'Costo promedio ponderado: (stock_actual * costo_anterior + cantidad_comprada * costo_compra) / (stock_actual + cantidad_comprada). DOMINIO POR DEFECTO.' },
...
export type MetodoCalculoValue = MetodoCalculo;
export type MetodoCalculoConsulta = typeof METODO_CALCULO_CONSULTA[number];
...
export const GRADO_EQUIVALENCIA_DEFAULT = [
    GradoEquivalencia.TOTAL
] as const;

export const GRADO_EQUIVALENCIA_CONSULTA = [
    GradoEquivalencia.TOTAL,
    GradoEquivalencia.PARCIAL,
    GradoEquivalencia.TERAPEUTICO,
    GradoEquivalencia.NINGUNO,
] as const;

export const GRADO_EQUIVALENCIA_METADATA: Record<GradoEquivalencia, DominioMetadata> = {
    ...
    [GradoEquivalencia.NINGUNO]: { id: GradoEquivalencia.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 4, descripcion: 'Sin grado de equivalencia definido. Valor por defecto para productos sin equivalencia registrada o cuando no aplica clasificación. DOMINIO POR DEFECTO.' },
};

export type GradoEquivalenciaValue = GradoEquivalencia;
export type GradoEquivalenciaConsulta = typeof GRADO_EQUIVALENCIA_CONSULTA[number];
...
export const TIPO_RECETA_DEFAULT = [
    TipoReceta.SIMPLE
] as const;

export const TIPO_RECETA_CONSULTA = [
    TipoReceta.SIMPLE,
    TipoReceta.ARCHIVADA,
    TipoReceta.VALADA,
    TipoReceta.NINGUNO,
] as const;

export const TIPO_RECETA_METADATA: Record<TipoReceta, DominioMetadata> = {
    ...
    [TipoReceta.NINGUNO]: { id: TipoReceta.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 4, descripcion: 'Sin tipo de receta definido. Valor por defecto para casos donde no se requiere receta médica (venta libre, productos OTC, dispositivos médicos) o cuando no aplica el control por receta. DOMINIO POR DEFECTO.' },
};

export type TipoRecetaValue = TipoReceta;
export type TipoRecetaConsulta = typeof TIPO_RECETA_CONSULTA[number];
...
export const MODALIDAD_FACTURACION_DEFAULT = [
    ModalidadFacturacion.NINGUNO
] as const;

export const MODALIDAD_FACTURACION_CONSULTA = [
    ModalidadFacturacion.NINGUNO,
    ModalidadFacturacion.ELECTRONICA,
    ModalidadFacturacion.COMPUTARIZADA,
    ModalidadFacturacion.MANUAL,
] as const;

export const MODALIDAD_FACTURACION_METADATA: Record<ModalidadFacturacion, DominioMetadata> = {
    [ModalidadFacturacion.NINGUNO]: { id: ModalidadFacturacion.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Modalidad de facturación ninguno. DOMINIO POR DEFECTO.' },
    ...
    [ModalidadFacturacion.MANUAL]: { id: ModalidadFacturacion.MANUAL, abreviatura: 'MANUAL', prefijo: 'MN', valor: 2, descripcion: 'Manual' },
};

export type ModalidadFacturacionValue = ModalidadFacturacion;
export type ModalidadFacturacionConsulta = typeof MODALIDAD_FACTURACION_CONSULTA[number];
...
export const TIPO_PUNTO_VENTA_DEFAULT = [
    TipoPuntoVenta.NINGUNO
] as const;

export const TIPO_PUNTO_VENTA_CONSULTA = [
    TipoPuntoVenta.NINGUNO,
    TipoPuntoVenta.CAJA,
] as const;

export const TIPO_PUNTO_VENTA_METADATA: Record<TipoPuntoVenta, DominioMetadata> = {
    [TipoPuntoVenta.NINGUNO]: { id: TipoPuntoVenta.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Tipo punto venta ninguno. DOMINIO POR DEFECTO.' },
    [TipoPuntoVenta.CAJA]: { id: TipoPuntoVenta.CAJA, abreviatura: 'CAJA', prefijo: 'CAJ', valor: 1, descripcion: 'Punto de venta caja.' },
};

export type TipoPuntoVentaValue = TipoPuntoVenta;
export type TipoPuntoVentaConsulta = typeof TIPO_PUNTO_VENTA_CONSULTA[number];
...
export const ESTADO_PROFORMA_DEFAULT = [
    EstadoProforma.NO_APLICA
] as const;

export const ESTADO_PROFORMA_CONSULTA = [
    EstadoProforma.NO_APLICA,
    EstadoProforma.PENDIENTE,
    EstadoProforma.CONVERTIDA,
    EstadoProforma.EXPIRADA,
    EstadoProforma.ANULADA,
] as const;

export const ESTADO_PROFORMA_METADATA: Record<EstadoProforma, DominioMetadata> = {
    [EstadoProforma.NO_APLICA]: { id: EstadoProforma.NO_APLICA, abreviatura: 'NO_APLICA', prefijo: null, valor: 0, descripcion: 'Proforma por default. DOMINIO POR DEFECTO.' },
    [EstadoProforma.PENDIENTE]: { id: EstadoProforma.PENDIENTE, abreviatura: 'PENDIENTE', prefijo: null, valor: 0, descripcion: 'Proforma o reserva emitida y pendiente de resolución o cobro. DOMINIO POR DEFECTO.' },
...
export type EstadoProformaValue = EstadoProforma;
export type EstadoProformaConsulta = typeof ESTADO_PROFORMA_CONSULTA[number];
...
export const TIPO_OPERACION_ALMACEN_DEFAULT = [
    TipoOperacionAlmacen.LOGISTICA_INTERNA
] as const;

export const TIPO_OPERACION_ALMACEN_CONSULTA = [
    TipoOperacionAlmacen.LOGISTICA_INTERNA,
    TipoOperacionAlmacen.VENTA_DIRECTA,
] as const;

export const TIPO_OPERACION_ALMACEN_METADATA: Record<TipoOperacionAlmacen, DominioMetadata> = {
    [TipoOperacionAlmacen.LOGISTICA_INTERNA]: { id: TipoOperacionAlmacen.LOGISTICA_INTERNA, abreviatura: 'LOGISTICA_INTERNA', prefijo: 'LI', valor: 0, descripcion: 'Almacén destinado a depósito general, tránsito o reabastecimiento interno sin venta directa. DOMINIO POR DEFECTO.' },
...
export type TipoOperacionAlmacenValue = TipoOperacionAlmacen;
export type TipoOperacionAlmacenConsulta = typeof TIPO_OPERACION_ALMACEN_CONSULTA[number];
...
export const ENTIDAD_AFECTADA_DEFAULT = [
    EntidadAfectada.PRODUCTOS
] as const;

export const ENTIDAD_AFECTADA_CONSULTA = [
    EntidadAfectada.PRODUCTOS,
    EntidadAfectada.LOTES,
    EntidadAfectada.VENTAS,
    EntidadAfectada.COMPRAS,
    EntidadAfectada.USUARIOS,
    EntidadAfectada.SUCURSALES,
    EntidadAfectada.PROVEEDORES,
    EntidadAfectada.CLIENTES,
    EntidadAfectada.FACTURAS,
    EntidadAfectada.PAGOS,
    EntidadAfectada.INVENTARIO,
    EntidadAfectada.NINGUNO,
] as const;

export const ENTIDAD_AFECTADA_METADATA: Record<EntidadAfectada, DominioMetadata> = {
    [EntidadAfectada.PRODUCTOS]: { id: EntidadAfectada.PRODUCTOS, abreviatura: 'PRODUCTOS', prefijo: 'PROD', valor: 0, descripcion: 'Productos del catalogo general. DOMINIO POR DEFECTO.' },
    ...
    [EntidadAfectada.NINGUNO]: { id: EntidadAfectada.NINGUNO, abreviatura: 'NINGUNO', prefijo: 'NIN', valor: 0, descripcion: 'Sin entidad afectada o registro neutral. DOMINIO POR DEFECTO.' },
};

export type EntidadAfectadaValue = EntidadAfectada;
export type EntidadAfectadaConsulta = typeof ENTIDAD_AFECTADA_CONSULTA[number];
...
export const CRITICIDAD_MEDICA_DEFAULT = [
    CriticidadMedica.NORMAL
] as const;

export const CRITICIDAD_MEDICA_CONSULTA = [
    CriticidadMedica.NORMAL,
    CriticidadMedica.CRITICO,
] as const;

export const CRITICIDAD_MEDICA_METADATA: Record<CriticidadMedica, DominioMetadata> = {
    [CriticidadMedica.NORMAL]: { id: CriticidadMedica.NORMAL, abreviatura: 'NORMAL', prefijo: null, valor: 0, descripcion: 'Producto sin criticidad medica especial. DOMINIO POR DEFECTO.' },
...
export type CriticidadMedicaValue = CriticidadMedica;
export type CriticidadMedicaConsulta = typeof CRITICIDAD_MEDICA_CONSULTA[number];
...
export const TIPO_PATRON_DEFAULT = [
    TipoPatron.DEMANDA
] as const;

export const TIPO_PATRON_CONSULTA = [
    TipoPatron.DEMANDA,
] as const;

export const TIPO_PATRON_METADATA: Record<TipoPatron, DominioMetadata> = {
    [TipoPatron.DEMANDA]: { id: TipoPatron.DEMANDA, abreviatura: 'DEMANDA', prefijo: 'DEM', valor: 0, descripcion: 'Patrón basado en la demanda histórica. DOMINIO POR DEFECTO.' },
};

export type TipoPatronValue = TipoPatron;
export type TipoPatronConsulta = typeof TIPO_PATRON_CONSULTA[number];
...
export const FUENTE_EXOGENA_DEFAULT = [
    FuenteExogena.SENAMHI
] as const;

export const FUENTE_EXOGENA_CONSULTA = [
    FuenteExogena.SENAMHI,
    FuenteExogena.INE,
    FuenteExogena.BCB,
    FuenteExogena.API_CLIMA,
    FuenteExogena.CALENDARIO_FESTIVOS,
    FuenteExogena.CUSTOM,
] as const;

export const FUENTE_EXOGENA_METADATA: Record<FuenteExogena, DominioMetadata> = {
    [FuenteExogena.SENAMHI]: { id: FuenteExogena.SENAMHI, abreviatura: 'SENAMHI', prefijo: null, valor: 0, descripcion: 'Servicio Nacional de Meteorologia e Hidrologia. DOMINIO POR DEFECTO.' },
...
export type FuenteExogenaValue = FuenteExogena;
export type FuenteExogenaConsulta = typeof FUENTE_EXOGENA_CONSULTA[number];
...
export const TIPO_BILLETE_MONEDA_DEFAULT = [
    TipoBilleteMoneda.NINGUNO
] as const;

export const TIPO_BILLETE_MONEDA_CONSULTA = [
    TipoBilleteMoneda.NINGUNO,
    TipoBilleteMoneda.B200,
    TipoBilleteMoneda.B100,
    TipoBilleteMoneda.B50,
    TipoBilleteMoneda.B20,
    TipoBilleteMoneda.B10,
    TipoBilleteMoneda.B5,
    TipoBilleteMoneda.B2,
    TipoBilleteMoneda.B1,
    TipoBilleteMoneda.M050,
    TipoBilleteMoneda.M020,
    TipoBilleteMoneda.M010,
    TipoBilleteMoneda.M10,
    TipoBilleteMoneda.M5,
    TipoBilleteMoneda.M2,
    TipoBilleteMoneda.M1,
] as const;

export const TIPO_BILLETE_MONEDA_METADATA: Record<TipoBilleteMoneda, DominioMetadata> = {
    [TipoBilleteMoneda.NINGUNO]: { id: TipoBilleteMoneda.NINGUNO, abreviatura: 'NINGUNO', prefijo: null, valor: 0, descripcion: 'Registro comodín para arqueos. DOMINIO POR DEFECTO.' },
...
export type TipoBilleteMonedaValue = TipoBilleteMoneda;
export type TipoBilleteMonedaConsulta = typeof TIPO_BILLETE_MONEDA_CONSULTA[number];
...
export const TIPO_APLICACION_DEFAULT = [
    TipoAplicacion.GLOBAL
] as const;

export const TIPO_APLICACION_CONSULTA = [
    TipoAplicacion.GLOBAL,
    TipoAplicacion.CATEGORIA,
    TipoAplicacion.LABORATORIO,
    TipoAplicacion.PRODUCTO,
] as const;

export const TIPO_APLICACION_METADATA: Record<TipoAplicacion, DominioMetadata> = {
    [TipoAplicacion.GLOBAL]: { id: TipoAplicacion.GLOBAL, abreviatura: 'GLOBAL', prefijo: null, valor: 0, descripcion: 'Política que aplica a todos los productos sin excepción. DOMINIO POR DEFECTO.' },
...
export type TipoAplicacionValue = TipoAplicacion;
export type TipoAplicacionConsulta = typeof TIPO_APLICACION_CONSULTA[number];
...
export const TIPO_ASISTENCIA_DEFAULT = [
    TipoAsistencia.NORMAL
] as const;

export const TIPO_ASISTENCIA_CONSULTA = [
    TipoAsistencia.NORMAL,
    TipoAsistencia.LICENCIA,
    TipoAsistencia.PERMISO,
    TipoAsistencia.JUSTIFICADA,
] as const;

export const TIPO_ASISTENCIA_METADATA: Record<TipoAsistencia, DominioMetadata> = {
    [TipoAsistencia.NORMAL]: { id: TipoAsistencia.NORMAL, abreviatura: 'NORMAL', prefijo: null, valor: 0, descripcion: 'Asistencia regular sin incidencias. Marcación de entrada y salida estándar. DOMINIO POR DEFECTO.' },
...
export type TipoAsistenciaValue = TipoAsistencia;
export type TipoAsistenciaConsulta = typeof TIPO_ASISTENCIA_CONSULTA[number];
...
export const ESTADO_ASISTENCIA_DEFAULT = [
    EstadoAsistencia.PRESENTE
] as const;

export const ESTADO_ASISTENCIA_CONSULTA = [
    EstadoAsistencia.PRESENTE,
...
export const ESTADO_ASISTENCIA_METADATA: Record<EstadoAsistencia, DominioMetadata> = {
    [EstadoAsistencia.PRESENTE]: { id: EstadoAsistencia.PRESENTE, abreviatura: 'PRESENTE', prefijo: null, valor: 0, descripcion: 'Trabajador asistió puntualmente y cumplió su jornada laboral completa. DOMINIO POR DEFECTO.' },
...
export type EstadoAsistenciaValue = EstadoAsistencia;
export type EstadoAsistenciaConsulta = typeof ESTADO_ASISTENCIA_CONSULTA[number];
...
export const METODO_MARCACION_DEFAULT = [
    MetodoMarcacion.MANUAL
] as const;

export const METODO_MARCACION_CONSULTA = [
    MetodoMarcacion.MANUAL,
    MetodoMarcacion.BIOMETRICO,
    MetodoMarcacion.QR,
    MetodoMarcacion.APP,
] as const;

export const METODO_MARCACION_METADATA: Record<MetodoMarcacion, DominioMetadata> = {
    [MetodoMarcacion.MANUAL]: { id: MetodoMarcacion.MANUAL, abreviatura: 'MANUAL', prefijo: null, valor: 0, descripcion: 'Registro manual por parte del supervisor o administrador. Requiere validación. DOMINIO POR DEFECTO.' },
...
export type MetodoMarcacionValue = MetodoMarcacion;
export type MetodoMarcacionConsulta = typeof METODO_MARCACION_CONSULTA[number];
...
export const TIPO_ALERTA_RRHH_DEFAULT = [
    TipoAlertaRRHH.RRHH
] as const;

export const TIPO_ALERTA_RRHH_CONSULTA = [
    TipoAlertaRRHH.RRHH,
    TipoAlertaRRHH.FALTAS_CONSECUTIVAS,
    TipoAlertaRRHH.BAJA_RENDIMIENTO,
    TipoAlertaRRHH.VENCIMIENTO_CONTRATO,
    TipoAlertaRRHH.CUMPLEANOS,
] as const;

export const TIPO_ALERTA_RRHH_METADATA: Record<TipoAlertaRRHH, DominioMetadata> = {
    [TipoAlertaRRHH.RRHH]: { id: TipoAlertaRRHH.RRHH, abreviatura: 'RRHH', prefijo: null, valor: 0, descripcion: 'Alerta relacionada con el módulo de Recursos Humanos. Agrupa notificaciones de asistencia, planillas y personal.' },
...
export type TipoAlertaRRHHValue = TipoAlertaRRHH;
export type TipoAlertaRRHHConsulta = typeof TIPO_ALERTA_RRHH_CONSULTA[number];
...
export const TIPO_PLANILLA_DEFAULT = [
    TipoPlanilla.SUELDOS
] as const;

export const TIPO_PLANILLA_CONSULTA = [
    TipoPlanilla.SUELDOS,
    TipoPlanilla.JORNALES,
    TipoPlanilla.CONTRATO,
] as const;

export const TIPO_PLANILLA_METADATA: Record<TipoPlanilla, DominioMetadata> = {
    [TipoPlanilla.SUELDOS]: { id: TipoPlanilla.SUELDOS, abreviatura: 'SUELDOS', prefijo: null, valor: 0, descripcion: 'Planilla mensual de sueldos para trabajadores con contrato indefinido o fijo. DOMINIO POR DEFECTO.' },
...
export type TipoPlanillaValue = TipoPlanilla;
export type TipoPlanillaConsulta = typeof TIPO_PLANILLA_CONSULTA[number];
...
export const ESTADO_PLANILLA_DEFAULT = [
    EstadoPlanilla.BORRADOR
] as const;

export const ESTADO_PLANILLA_CONSULTA = [
    EstadoPlanilla.BORRADOR,
...
export const ESTADO_PLANILLA_METADATA: Record<EstadoPlanilla, DominioMetadata> = {
    [EstadoPlanilla.BORRADOR]: { id: EstadoPlanilla.BORRADOR, abreviatura: 'BORRADOR', prefijo: null, valor: 0, descripcion: 'Planilla en edición. Los valores pueden ser modificados. No está lista para aprobación. DOMINIO POR DEFECTO.' },
...
export type EstadoPlanillaValue = EstadoPlanilla;
export type EstadoPlanillaConsulta = typeof ESTADO_PLANILLA_CONSULTA[number];
...
export const ESTADO_CONTRATO_DEFAULT = [
    EstadoContrato.VIGENTE
] as const;

export const ESTADO_CONTRATO_CONSULTA = [
    EstadoContrato.VIGENTE,
...
export const ESTADO_CONTRATO_METADATA: Record<EstadoContrato, DominioMetadata> = {
    [EstadoContrato.VIGENTE]: { id: EstadoContrato.VIGENTE, abreviatura: 'VIGENTE', prefijo: null, valor: 0, descripcion: 'Contrato activo y operativo. El trabajador se encuentra en funciones. DOMINIO POR DEFECTO.' },
...
export type EstadoContratoValue = EstadoContrato;
export type EstadoContratoConsulta = typeof ESTADO_CONTRATO_CONSULTA[number];
...
export const TIPO_CONTRATO_DEFAULT = [
    TipoContrato.INDEFINIDO
] as const;

export const TIPO_CONTRATO_CONSULTA = [
    TipoContrato.INDEFINIDO,
    TipoContrato.FIJO,
...
export const TIPO_CONTRATO_METADATA: Record<TipoContrato, DominioMetadata> = {
    [TipoContrato.INDEFINIDO]: { id: TipoContrato.INDEFINIDO, abreviatura: 'INDEFINIDO', prefijo: null, valor: 0, descripcion: 'Contrato sin fecha de término definida. Establece relación laboral permanente. DOMINIO POR DEFECTO.' },
...
export type TipoContratoValue = TipoContrato;
export type TipoContratoConsulta = typeof TIPO_CONTRATO_CONSULTA[number];
...
export const TIPO_JORNADA_DEFAULT = [
    TipoJornada.COMPLETA
] as const;

export const TIPO_JORNADA_CONSULTA = [
    TipoJornada.COMPLETA,
    TipoJornada.MEDIA,
    TipoJornada.POR_HORAS,
] as const;

export const TIPO_JORNADA_METADATA: Record<TipoJornada, DominioMetadata> = {
    [TipoJornada.COMPLETA]: { id: TipoJornada.COMPLETA, abreviatura: 'COMPLETA', prefijo: null, valor: 0, descripcion: 'Jornada laboral completa (40 horas semanales). DOMINIO POR DEFECTO.' },
...
export type TipoJornadaValue = TipoJornada;
export type TipoJornadaConsulta = typeof TIPO_JORNADA_CONSULTA[number];
