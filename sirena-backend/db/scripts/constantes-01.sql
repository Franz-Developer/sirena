...
export const EVENTO_METADATA: Record<Evento, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_COMPROBANTE_METADATA: Record<TipoComprobante, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const GENERO_METADATA: Record<Genero, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_CIVIL_MASCULINO_METADATA: Record<EstadoCivilMasculino, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_CIVIL_FEMENINO_METADATA: Record<EstadoCivilFemenino, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_VENTA_METADATA: Record<TipoVenta, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_PAGO_METADATA: Record<TipoPago, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_MODELO_METADATA: Record<TipoModelo, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_BENEFICIO_METADATA: Record<TipoBeneficio, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_PRONOSTICO_METADATA: Record<EstadoPronostico, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TEMPORADA_METADATA: Record<Temporada, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_CUENTA_METADATA: Record<TipoCuenta, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_DATO_METADATA: Record<TipoDato, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const NIVEL_URGENCIA_METADATA: Record<NivelUrgencia, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const MOTIVO_OUTLIER_METADATA: Record<MotivoOutlier, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_MODELO_METADATA: Record<EstadoModelo, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const CALIDAD_RATING_METADATA: Record<CalidadRating, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_TRASPASO_METADATA: Record<EstadoTraspaso, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const MODULO_ESTRATEGICO_METADATA: Record<ModuloEstrategico, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_MONEDA_METADATA: Record<TipoMoneda, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_FACTURA_METADATA: Record<TipoFactura, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_FINANCIERO_METADATA: Record<EstadoFinanciero, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const MOTIVO_ANULACION_METADATA: Record<MotivoAnulacion, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_LOTE_METADATA: Record<EstadoLote, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_PAGO_METADATA: Record<EstadoPago, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_MOVIMIENTO_METADATA: Record<TipoMovimiento, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_CAJA_METADATA: Record<EstadoCaja, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_ALERTA_NOTIFICACION_METADATA: Record<TipoAlertaNotificacion, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const AMBIENTE_METADATA: Record<Ambiente, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const SUBTIPO_ALERTA_METADATA: Record<SubtipoAlerta, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ORIGEN_ALERTA_METADATA: Record<OrigenAlerta, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const NIVEL_CRITICO_METADATA: Record<NivelCritico, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_ALERTA_METADATA: Record<EstadoAlerta, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const FRAMEWORK_METADATA: Record<Framework, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_EJECUCION_METADATA: Record<EstadoEjecucion, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_METRICA_METADATA: Record<TipoMetrica, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const NIVEL_LOG_METADATA: Record<NivelLog, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_UBICACION_MOVIMIENTO_METADATA: Record<TipoUbicacionMovimiento, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_UMBRAL_METADATA: Record<TipoUmbral, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_DOCUMENTO_METADATA: Record<EstadoDocumento, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const FRECUENCIA_METADATA: Record<Frecuencia, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_TAREA_METADATA: Record<TipoTarea, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const SUBTIPO_TAREA_METADATA: Record<SubtipoTarea, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_DESPACHO_METADATA: Record<TipoDespacho, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const METRICA_PRECISION_METADATA: Record<MetricaPrecision, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const FACTOR_ESTACIONALIDAD_METADATA: Record<FactorEstacionalidad, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_PEDIDO_ONLINE_METADATA: Record<EstadoPedidoOnline, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const METODO_CALCULO_METADATA: Record<MetodoCalculo, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const GRADO_EQUIVALENCIA_METADATA: Record<GradoEquivalencia, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_RECETA_METADATA: Record<TipoReceta, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const MODALIDAD_FACTURACION_METADATA: Record<ModalidadFacturacion, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_PUNTO_VENTA_METADATA: Record<TipoPuntoVenta, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_PROFORMA_METADATA: Record<EstadoProforma, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ENTIDAD_AFECTADA_METADATA: Record<EntidadAfectada, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const CRITICIDAD_MEDICA_METADATA: Record<CriticidadMedica, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_PATRON_METADATA: Record<TipoPatron, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const FUENTE_EXOGENA_METADATA: Record<FuenteExogena, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_BILLETE_MONEDA_METADATA: Record<TipoBilleteMoneda, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_APLICACION_METADATA: Record<TipoAplicacion, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_ASISTENCIA_METADATA: Record<TipoAsistencia, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_ASISTENCIA_METADATA: Record<EstadoAsistencia, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const METODO_MARCACION_METADATA: Record<MetodoMarcacion, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_PLANILLA_METADATA: Record<TipoPlanilla, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_PLANILLA_METADATA: Record<EstadoPlanilla, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const ESTADO_CONTRATO_METADATA: Record<EstadoContrato, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_CONTRATO_METADATA: Record<TipoContrato, ConstanteMetadata & { es_defecto?: boolean }> = {
...
export const TIPO_JORNADA_METADATA: Record<TipoJornada, ConstanteMetadata & { es_defecto?: boolean }> = {
