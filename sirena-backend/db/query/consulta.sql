...
SELECT
    ...
    CASE
        WHEN EXISTS (
            ...
            JOIN information_schema.key_column_usage kcu_pk ON tc_pk.constraint_name = kcu_pk.constraint_name AND tc_pk.table_schema = kcu_pk.table_schema
...
JOIN information_schema.columns AS c ON c.table_name = ccu.table_name AND c.table_schema = ccu.table_schema
WHERE tc.constraint_type = 'FOREIGN KEY'
    AND tc.table_schema = 'public'
